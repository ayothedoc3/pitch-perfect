                ...
                <div className="space-y-4 text-gray-700">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-blue-50 rounded-lg">
                      ...
                      <p>{Math.round(pitch.analysis.metrics.pacing)} words per minute</p>
                    </div>
                    <div className="p-4 bg-purple-50 rounded-lg">
                      <h4 className="font-semibold text-purple-900 mb-2">Tone Variation</h4>
                      <p>{Math.round(pitch.analysis.metrics.toneVariation * 100)}%</p>
                    </div>
                    <div className="p-4 bg-green-50 rounded-lg">
                      <h4 className="font-semibold text-green-900 mb-2">Clarity</h4>
                      <p>{Math.round(pitch.analysis.metrics.clarity * 100)}%</p>
                    </div>
                    <div className="p-4 bg-yellow-50 rounded-lg">
                      <h4 className="font-semibold text-yellow-900 mb-2">Filler Words</h4>
                      <p>{Math.round(pitch.analysis.metrics.fillerWordFrequency * 100)}%</p>
                    </div>
                  </div>
